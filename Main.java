...
//		Rod rod1 = new Rod(5,5);
//		TowerOfHanoi test = new TowerOfHanoi(3, 5);
//		rod1.push(disk1);
//		rod1.push(disk1);
//		//rod1.push(disk3);
//		//rod1.push(disk2);
...
//		//push(disk3);
//
//		System.out.print(rod1.toString());
//		System.out.println(rod1.isFull());
//		System.out.println(rod1.isEmpty());
//		System.out.println(test.toString());
//		//System.out.println(rod1.peek());
//	}
//}
...
public class Main {	
    public static void main(String[] args) {
    	...
    	final String ROD_LETTERS = "QWERTYUIOP".substring(0, PUZZLE_WIDTH); // labels for rods
...
// SAVE FOR STEP 5:
        ...
        while (!isDone) {
            ...
            if (input.length() != 2) System.out.println("WARNING: A move should consist of two letters.");
